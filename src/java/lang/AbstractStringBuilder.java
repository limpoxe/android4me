...
abstract class AbstractStringBuilder {
    ...
    /*
     * Replacement for value.clone()
     */
    private final char[] cloneValue() {
    ...
    final void append0(String s, int start, int end) {
        if (s == null) {
            s = "null"; //$NON-NLS-1$
        }
    ...
    final void insert0(int index, String s, int start, int end) {
        if (s == null) {
            s = "null"; //$NON-NLS-1$
        }
